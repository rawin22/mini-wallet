          ...
          {showUserMenu && (
            <div className="user-dropdown">
              ...
              <ul className="user-dropdown-menu">
                <li><a href="#" onClick={(e) => { e.preventDefault(); navigate('/profile'); setShowUserMenu(false); }}>{t('nav.profile')}</a></li>
                <li><a href="#" onClick={(e) => { e.preventDefault(); navigate('/change-password'); setShowUserMenu(false); }}>{t('nav.changePassword')}</a></li>
              </ul>
              <div className="user-dropdown-divider" />
              <ul className="user-dropdown-menu">
